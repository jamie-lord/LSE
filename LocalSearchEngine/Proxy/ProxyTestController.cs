...
namespace LocalSearchEngine
{
    public class ProxyTestController
    {
        ...
        public ProxyTestController()
        {
            ...
            proxyServer.RootCertificate = new X509Certificate2($"{dir}/2.cer", string.Empty, X509KeyStorageFlags.Exportable);
        }
        ...
        public void StartProxy()
        {
            ...
            var explicitEndPoint = new ExplicitProxyEndPoint(IPAddress.Any, _port, true)
            {
